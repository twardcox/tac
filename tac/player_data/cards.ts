...
const cards: CardsProps = {
  1: {
    ...
    game_effect: ['entrance', 'moveForward'],
    deck_qty: 9,
  },
  2: {
    title: 'two',
    description: 'Move one marble forward two spaces.',
    game_effect: ['moveForward'],
    deck_qty: 7,
  },
  3: {
    title: 'three',
  ...
  4: {
    ...
    game_effect: ['entrance', 'moveBackward'],
    deck_qty: 7,
  },
  5: {
    title: 'five',
  ...
  8: {
    ...
    game_effect: ['nextPlayerLoseTurn', 'moveForward'],
    deck_qty: 7,
  },
  9: {
    title: 'nine',
